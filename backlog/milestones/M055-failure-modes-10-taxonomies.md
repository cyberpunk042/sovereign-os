...
| E0531 | Sandbox Failure + Memory Failure — Sandbox 7 failure types (container escape risk / mount misconfiguration / network leakage / GPU device overexposed / filesystem too broad / secret leaked into sandbox / checkpoint restore failed) + 7-step mitigation (least privilege mounts / stub credentials / network namespaces / AppArmor-seccomp / eBPF observation / ZFS snapshots / VM for high-risk tasks) + "The 4090 VFIO VM is the hard boundary profile"; Memory 7 failure types (stale fact / contradictory memory / private memory exposed / bad summary promoted / poisoned memory / irrelevant retrieval / context bloat) + 7-step mitigation (trust-freshness metadata / raw trace preservation / quarantine state / memory provenance / forget-delete support / verification before promotion / policy check on read) + "Summaries are derived artifacts, not authority" | 17034–17086 |
...
| M00923 | Failure mode 5 — Sandbox Failure (7 types + 7-step mitigation + "4090 VFIO VM is the hard boundary profile") | 17034–17064 | E0531 |
...
| F04630 | Sandbox doctrine — "The 4090 VFIO VM is the hard boundary profile" | 17064 | M00923 |
...
| R09254 | "The 4090 VFIO VM is the hard boundary profile" | 17064 | F04630 | non-negotiable | false | 10 |
