...
| E0402 | North Star — Anthropic-first API gateway + deterministic AVX-512 control plane + Blackwell oracle + 3090 scout/sandbox + model portfolio lab + MAP/SPEC/TDD workflow compiler + sandboxed execution + trace-based evals + memory/replay/learning; key phrase "Evidence-driven autonomy" ("Not pure agent freedom. Not rigid workflow prison. A system that maps, specifies, tests, acts, evaluates, commits, and learns, using the right amount of intelligence for the task") | 12262–12286 |
...
| F03547 | North-Star component — 3090 scout/sandbox | 12267 | E0402 |
...
| R07078 | North-Star — 3090 scout/sandbox | 12267 | F03547 | non-negotiable | false | 10 |
