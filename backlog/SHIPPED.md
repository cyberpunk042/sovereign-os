...
>
> The catalogue is `backlog/INDEX.md` (84 milestone files / 14,249 distinct R-rows — INDEX is generated by `scripts/backlog/gen-index.py` since 2026-07-17, so its totals are the authoritative live figures). This file is the orthogonal "delivery state" view per the operator's standing constraint:
>
...
| State | R-rows | % of 14,249 |
|---|---:|---:|
| Catalogued (total) | 14,249 | 100% |
