...
ARCHITECTURE_CONCEPTS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "explanation": ("Section 1.1 Core Components — operator-verbatim "
                         ...
                         "from local storage). Management NIC: Intel "
                         "I226-V 2.5GbE (per §8 secure-management "
                         "interface). Operator §1b hardware-spec drops "
                         "additional SKUs: RAM Corsair Vengeance DDR5 "
                         "CMK128GX5M2B6400C42 (2x64GB×2 kits → 4 DIMMs "
                         "= 256GB at 6400MHz CL42-52-52-104 1.35V Intel "
                         "XMP 3.0); NVMe 2x Samsung 990 EVO Plus 2TB "
                         "PCIe Gen4 x4 / Gen5 x2; UPS APC Smart-UPS "
                         "2200VA 1980W LCD Tower SmartConnect 20A 120V "
                         "SMT2200C; PSU be Quiet! Dark Power Pro 13 "
