...
MODULE_COVERAGE = {
    "auth-tier": {
        "shipped_in": "R450 (E11.M7) + R484 (E11.M7+ Grafana dashboard) + R501 (E11.M7++ read-only REST API + systemd service)",
    ...
    "edge-firewall": {
        "shipped_in": "R451 (E11.M9) + R482 (E11.M9+ wizard tui) + R485 (E11.M9+ Grafana dashboard)",
    ...
    "global-history": {
        "shipped_in": "R448 (E11.M5) + R481 (E11.M5+ tui surface) + R487 (E11.M5+ Grafana dashboard)",
        "surfaces": ["core", "cli", "tui", "dashboard"],
        "waivers": {
