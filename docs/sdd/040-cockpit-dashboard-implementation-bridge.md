...
- **Shipped (full stack → prod)**: D-00, D-01, D-02, D-03, D-04, D-05, D-06, D-07, D-08, D-09, D-10, D-11, D-13, D-15, D-16, D-17, D-18 (17 dashboards)
- **Shipped (split or partial)**: D-12, D-14, D-19, D-20 (4 dashboards — already-shipped surfaces with partial coverage; see Phase E completions below)
- **Backend API pending**: NONE. Every one of the 21 M060 cockpit dashboards now has a working backend + webapp; the 5 selfdef-domain surfaces (D-02 profiles + D-13/D-15/D-17/D-18) ship as cross-repo READ-ONLY mirrors (`scripts/mirror/selfdef-*-mirror.py`, never mutate IPS state), correctly placed per the operator project-boundary directive. Remaining work is the Phase E **partial-completions** of D-14 (capability_word grants on auth-tier), D-19 (super-model manifest table on trinity), D-20 (5-property peace-machine live view on compliance) — extensions of surfaces that already ship.
