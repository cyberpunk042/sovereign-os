...
- **Shipped (full stack → prod)**: D-00, D-01, D-03, D-04, D-05, D-06, D-08, D-09, D-10, D-11, D-16 (11 dashboards)
- **Shipped (split or partial)**: D-12, D-14, D-19, D-20 (4 dashboards)
- **Webapp scaffold present, backend API pending**: D-02, D-07, D-13, D-15, D-17, D-18 (6 dashboards). NOTE: D-07 carries inline mock data + references `/api/d-07/...` (needs a frontend fetch-wiring pass like D-08 got); D-02 is the selfdef-authority profile mirror; D-13/D-15/D-17/D-18 are selfdef-mirror dashboards (D-040.6/.8 — consume MS007 typed-mirror crates, cross-repo).
