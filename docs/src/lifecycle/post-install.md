...
| `vfio-bind-3090.sh` | Configure GRUB cmdline `vfio-pci.ids=10de:2204,10de:1ad8`; write `/etc/modprobe.d/vfio.conf`; rebuild initramfs |
...
2. vfio-bind-3090           ── reboot required after
3. (REBOOT)
