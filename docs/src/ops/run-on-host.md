...
```bash
python3 scripts/install/operator-deps.py --config operator-deps.toml plan             # report only
python3 scripts/install/operator-deps.py --config operator-deps.toml apply --confirm # gated apply
```
