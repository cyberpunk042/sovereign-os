...
| 2026-07-16 | [009-test-performance-audit-and-plan.md](009-test-performance-audit-and-plan.md) | (companion to 008 — CI/test-throughput audit: ~8-min wall-clock diagnosed to duplicated layer-1 pytest + zero change-awareness + no intra-job parallelism; tiered plan Tier 0→3; Tier-0 concurrency-cancel shipped, de-dup + xdist + path-filters + nextest staged with verification gates) |
