...
```
   ...
   Fourth repo:
   ┌───────────────────────┐
   │  root-modules      │   active (endpoint mode; SDD-046)
   └───────────────────────┘
```
